...
const raceData = {
  human: {
    name: "انسان",
    female: "assets/human-female.png",
    male: "assets/human-male.png"
  },
  dwarf: {
    name: "دروف",
    female: "assets/dwarf-female.png",
    male: "assets/dwarf-male.png"
  },
  dragon: {
    name: "نیمه دراگون",
    female: "assets/dragon-female.png",
    male: "assets/dragon-male.png"
  },
  halfHuman: {
    name: "نیمه انسان",
    female: "assets/halfhuman-female.png",
    male: "assets/halfhuman-male.png"
  },
  angel: {
    name: "فرشته",
    female: "assets/angel-female.png",
    male: "assets/angel-male.png"
  },
  elf: {
    name: "الف",
    female: "assets/elf-female.png",
    male: "assets/elf-male.png"
  }
};
...
raceButtons.forEach(button => {
  button.addEventListener("click", () => {
    ...
    characterPreview.innerHTML = `
      <img src="${race.female}" alt="${race.name} زن">
      <img src="${race.male}" alt="${race.name} مرد">
    `;
